export const blogContent: Record<string, any> = {
  "gender-bias-hiring": {
    ...
    readTime: "7 min read",
    image: "🚀",
    content: `Gender bias in hiring is one of the most persistent forms of workplace discrimination. Despite efforts to promote equality, research shows that gender-coded language in job descriptions and resumes continues to influence hiring decisions—often unconsciously.
...
Taking action on gender bias isn't just ethical—it's smart business.`,
  ...
  "age-discrimination-recruiting": {
    ...
    readTime: "8 min read",
    image: "⚖️",
    content: `Age discrimination in hiring is illegal under the Age Discrimination in Employment Act (ADEA), yet it remains widespread. The problem isn't always obvious—it hides in "age proxies" that signal a candidate's age without mentioning it directly.
...
Eliminating age discrimination isn't just legally necessary—it builds stronger teams.`,
  ...
  "ai-bias-detection": {
    ...
    readTime: "9 min read",
    image: "🤖",
    content: `Modern AI-powered tools can analyze resumes at scale and identify subtle bias markers that humans often miss. But how does this work, and can we trust AI to be unbiased?
...
The future of fair hiring combines AI efficiency with human wisdom.`,
  ...
  "inclusive-hiring-practices": {
    ...
    readTime: "6 min read",
    image: "🤝",
    content: `Building truly diverse and inclusive teams requires more than good intentions. Here are five evidence-based practices that work.
...
Inclusive hiring is an ongoing practice, not a box to check. Commit to measurement and continuous improvement for sustainable results.`,
  ...
  "resume-bias-examples": {
    ...
    image: "📝",
    content: `Let's look at real examples of bias-coded language in resumes and how to rewrite them for fairer evaluation.
...
The goal isn't political correctness—it's fair evaluation of actual qualifications.`,
  ...
  "diversity-metrics": {
    ...
    readTime: "7 min read",
    image: "📊",
    content: `You can't improve what you don't measure. Here are the key metrics that matter for tracking diversity in hiring.
...
Fair hiring is measurable, trackable, and improvable.`,
  ...
  "name-bias-hiring": {
    ...
    readTime: "8 min read",
    image: "📋",
    content: `One of the most proven forms of hiring bias is name-based discrimination. The research is damning, and the solution is clear.
...
Name bias is real, measurable, and preventable. Blind resume review is one of the highest-impact, lowest-cost interventions in fair hiring. There's no reason not to implement it.`,
  ...
  "job-description-bias": {
    ...
    readTime: "6 min read",
    image: "✍️",
    content: `Job descriptions are often the first touchpoint in hiring. Biased language here filters out candidates before they even apply. Here's how to write descriptions that attract diverse talent.
...
Your job description is your first invitation. Make it welcoming to everyone.`,
  ...
  "unconscious-bias-training": {
    ...
    readTime: "9 min read",
    image: "🎓",
    content: `Unconscious bias training is everywhere—and research shows it often doesn't work. Here's what actually changes hiring outcomes.
...
Fair hiring isn't about checking a box with annual training. It requires systematic change, measurement, and commitment. Make it a business priority, and you'll see results.`,
  ...
  "fair-hiring-roi": {
    ...
    readTime: "7 min read",
    image: "💰",
    content: `Fair hiring and diversity aren't just ethical imperatives—they're smart business. Here's what the research says about ROI.
